...
import { FaStar, FaHome, FaPhone, FaEnvelope, FaIdCard, FaCheckCircle, FaMapMarkerAlt, FaCalendar, FaImages } from 'react-icons/fa';
    ...
    const handleContact = () => {
        navigate('/ContactForm', { 
            state: { 
                ...
                serviceSelected: profile.serviceType,
                price: profile.price
            }
        });
    };
